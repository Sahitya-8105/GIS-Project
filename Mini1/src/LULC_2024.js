...
// Load and preprocess Landsat 8 imagery
...
var inputBands = ['B2', 'B3', 'B4', 'B5', 'B6', 'B7'];
...
var chart = ui.Chart.feature.byFeature(features, 'LandCoverClass', ['Area_sqkm'])
  ...
  .setOptions({
    title: 'Land Cover Area (sq.km) - 2024',
...
Export.image.toDrive({
  ...
  description: 'LULC_2024_RF', 
  folder: 'GEE_LULC',
  fileNamePrefix: 'LULC_2024', 
